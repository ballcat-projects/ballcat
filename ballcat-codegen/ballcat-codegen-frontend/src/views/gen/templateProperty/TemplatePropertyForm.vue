<template>
  <a-form @submit="handleSubmit" :form="form">
    ...
    <a-form-item label="模板组ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-input placeholder="模板组ID" v-decorator="['groupId']" />
    </a-form-item>
    ...
    <a-form-item label="属性值" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-input placeholder="属性值" v-decorator="['propValue']" />
    </a-form-item>
    ...
    <a-form-item label="必填，1：是，0：否" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-input placeholder="必填，1：是，0：否" v-decorator="['required']" />
    </a-form-item>
