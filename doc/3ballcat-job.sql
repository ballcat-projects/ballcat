...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'ballcat-admin-job', 'Admin Job执行器', 1, 0, NULL);
INSERT INTO `xxl_job_group` VALUES (2, 'ballcat-api-job', 'Api job执行器', 2, 0, NULL);
...
-- ----------------------------
INSERT INTO `ballcat_job`.`xxl_job_info` VALUES (1, 1, '0 0/1 * * * ? ', 'Admin Demo Job', '2019-10-19 19:56:37', '2019-10-19 20:04:40', 'BallCat Admin', '', 'ROUND', 'adminDemoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2019-10-19 19:56:37', '', 1, 1571486940000, 1571487000000);
INSERT INTO `ballcat_job`.`xxl_job_info` VALUES (2, 2, '0 0/1 * * * ? ', 'Api Demo Job', '2019-10-19 19:56:37', '2019-10-19 20:04:49', 'BallCat Api', '', 'ROUND', 'apiDemoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2019-10-19 19:56:37', '', 1, 1571486940000, 1571487000000);
